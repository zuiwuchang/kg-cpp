#ifndef KG_SCRIPTS_DUKTAPE_EXTRAS_PRINT_ALERT_HEADER_HPP
#define KG_SCRIPTS_DUKTAPE_EXTRAS_PRINT_ALERT_HEADER_HPP
...
#endif // KG_SCRIPTS_DUKTAPE_EXTRAS_PRINT_ALERT_HEADER_HPP
